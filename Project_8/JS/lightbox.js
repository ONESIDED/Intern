!function() {
    ...
    function() {
        ...
        return t.init = function(e, t, i) {
            this.userSettings = i;
            var n, r = document.createElement("figure"), o = document.createElement("figcaption"), a = document.createElement("img"), s = e.querySelector("img"), d = document.createElement("div");
            r.style.opacity = "0",
            s && (a.alt = s.alt || ""),
            a.setAttribute("src", ""),
            ...
            r.appendChild(a),
            this.userSettings.captions && ("function" == typeof this.userSettings.captionText ? n = this.userSettings.captionText(e) : "self" === this.userSettings.captionsSelector && e.getAttribute(this.userSettings.captionAttribute) ? n = e.getAttribute(this.userSettings.captionAttribute) : "img" === this.userSettings.captionsSelector && s && s.getAttribute(this.userSettings.captionAttribute) && (n = s.getAttribute(this.userSettings.captionAttribute)),
            this.userSettings.captionHTML ? o.innerHTML = n : o.textContent = n,
            n && (o.id = "tobii-figcaption-" + this.figcaptionId,
            r.appendChild(o),
            ...
            d.setAttribute("aria-label", this.userSettings.loadingIndicatorLabel),
            t.appendChild(d),
    ...
    function() {
        ...
        t.onLoad = function(e, t) {
            ...
            i && (i.hasAttribute("data-time") && i.readyState > 0 && (i.currentTime = i.getAttribute("data-time")),
    ...
    function a(e) {
        var s = {
          ...
          , q = function(e) {
            if (I = P(e),
            Object.prototype.hasOwnProperty.call(S, I) || (S[I] = JSON.parse(JSON.stringify(c)),
            Y()),
            -1 !== S[I].gallery.indexOf(e))
                throw new Error("Ups, element already added.");
            if (S[I].gallery.push(e),
            S[I].elementsLength++,
          ...
          , N = function(e) {
            ...
            if (ce() && t === C && i === S[t].currentIndex) {
                ...
                0 === S[t].currentIndex ? H() : R(),
                de(),
                le()
            }
            if (S[t].gallery.splice(S[t].gallery.indexOf(e)),
          ...
          , R = function() {
            ...
            S[C].currentIndex > 0 && (B(S[C].currentIndex),
            M(--S[C].currentIndex),
            le("left"),
          ...
          , H = function() {
            if (!ce())
                throw new Error("Ups, I'm closed.");
            S[C].currentIndex < S[C].elementsLength - 1 && (B(S[C].currentIndex),
            M(++S[C].currentIndex),
            le("right"),
            V(S[C].currentIndex - 1),
            z(S[C].currentIndex + 1));
          ...
          , j = function() {
            S[C = null !== C ? C : I].slider.style.transform = "translate3d(" + (E = -S[C].currentIndex * p.offsetWidth) + "px, 0, 0)",
            L = E
        }
          , W = function() {
            g = {
          ...
          , K = function(e) {
            e.target === b ? R() : e.target === h ? H() : (e.target === f || !1 === v && !1 === y && e.target.classList.contains("tobii__slide") && l.docClose) && X(),
            e.stopPropagation()
        }
          , Q = function(e) {
            ...
            R()) : 39 !== e.keyCode && "ArrowRight" !== e.code || (e.preventDefault(),
            H())
        }
          , Z = function(e) {
          ...
          , oe = function() {
            Math.abs(g.startX - g.endX) > 0 && !y && S[C].elementsLength > 1 ? (S[C].slider.style.transform = "translate3d(" + (L - Math.round(g.startX - g.endX)) + "px, 0, 0)",
            v = !0,
            y = !1) : Math.abs(g.startY - g.endY) > 0 && !v && l.swipeClose && (S[C].slider.style.transform = "translate3d(" + L + "px, -" + Math.round(g.startY - g.endY) + "px, 0)",
            v = !1,
            y = !0)
        }
          , ae = function() {
          ...
          , de = function() {
            (l.draggable && l.swipeClose && pe() && !S[C].slider.classList.contains("tobii__slider--is-draggable") || l.draggable && S[C].elementsLength > 1 && !S[C].slider.classList.contains("tobii__slider--is-draggable")) && S[C].slider.classList.add("tobii__slider--is-draggable"),
            !l.nav || 1 === S[C].elementsLength || "auto" === l.nav && pe() ? (b.setAttribute("aria-hidden", "true"),
            b.disabled = !0,
            ...
            h.disabled = !1),
            m.setAttribute("aria-hidden", l.counter && 1 !== S[C].elementsLength ? "false" : "true")
        }
          , le = function(e) {
            void 0 === e && (e = null),
            j(),
            ...
            function(e) {
                (!0 === l.nav || "auto" === l.nav) && !pe() && S[C].elementsLength > 1 ? (b.setAttribute("aria-hidden", "true"),
                b.disabled = !0,
                h.setAttribute("aria-hidden", "true"),
                h.disabled = !0,
                1 === S[C].elementsLength ? l.close && f.focus() : 0 === S[C].currentIndex ? (h.setAttribute("aria-hidden", "false"),
                h.disabled = !1,
                h.focus()) : S[C].currentIndex === S[C].elementsLength - 1 ? (b.setAttribute("aria-hidden", "false"),
                b.disabled = !1,
